...
public static class SeedProductsBase
{
    public static void SeedProducts(this ModelBuilder builder)
    {
        ...
        builder.Entity<ProductCategory>().HasData(baseCategories);

        var products = new List<Product> {
            new Product{Id = Guid.NewGuid(),  CategoryId = baseCategories[0].Id,
            ...
            new Product{Id = Guid.NewGuid(), CategoryId = baseCategories[1].Id,
